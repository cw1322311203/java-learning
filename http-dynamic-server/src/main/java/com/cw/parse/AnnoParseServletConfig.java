package com.cw.parse;

import com.cw.httpserver.NotImplementsHttpServletException;
import com.cw.httpserver.ServletConcurrentHashMap;
import com.cw.myservlet.HttpServlet;
...
public class AnnoParseServletConfig implements ParseServletConfig {
    ...
    //定义一个servlet路径所对应的常量
    public static final String SERVLET_PATH = "http-dynamic-server\\src\\com\\cw\\myservlet";

    //定义包名
    public static final String SERVLET_PACKAGE_NAME = "com.cw.myservlet.";
